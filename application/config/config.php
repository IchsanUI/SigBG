...
|
*/
$config['base_url'] = 'http://localhost/SigBG/';
...
|
*/
$config['encryption_key'] = 'CHANGE_ME_generate_random_32_char_string_xyz123';
...
$config['sess_cookie_name'] = 'sigbg_session';
$config['sess_samesite'] = 'Lax';
$config['sess_expiration'] = 7200;
$config['sess_save_path'] = sys_get_temp_dir().'/sigbg_sessions';
